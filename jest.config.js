...
const customJestConfig = {
  ...
  moduleNameMapper: {
    ...
    '^../../../lib/carbon/department-project-service$': '<rootDir>/src/__mocks__/lib/carbon/department-project-service.ts',
    '^../lib/carbon/cloverly-client$': '<rootDir>/src/__mocks__/lib/carbon/cloverly-client.ts',
    '^../../../lib/carbon/cloverly-client$': '<rootDir>/src/__mocks__/lib/carbon/cloverly-client.ts',
    ...
    '^recharts/(.*)$': '<rootDir>/__mocks__/recharts/index.js',
    '^../components/carbon/CarbonGoalCard$': '<rootDir>/src/__mocks__/carbon-goal-card.tsx',
  },
